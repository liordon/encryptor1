...
import ofek.crypto.DoubleEncryption;
import ofek.crypto.EncryptionAlgorithm;
import ofek.crypto.ShiftUpEncryption;

public class EncryptionSoftware {
  private static EncryptionAlgorithm ea = new DoubleEncryption(new ShiftUpEncryption());
