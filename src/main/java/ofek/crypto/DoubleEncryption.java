...
public class DoubleEncryption implements EncryptionAlgorithm {
  ...
  /**
   * this function exists mostly for compatibility purposes.
   * it performs the second encryption with a key of twice the original value.
   */
  @Override
  ...
  /**
   * this function exists mostly for compatibility purposes.
   * it performs the first decryption with a key of twice the original value.
   */
  @Override
